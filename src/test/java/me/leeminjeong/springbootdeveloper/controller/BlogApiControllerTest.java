...
class BlogApiControllerTest {
    ...
    // 자바 객체를 JSON 데이터로 변환 == 직렬화 , 반대로 JSON 데이터를 자바에서 사용하기 위해 자바 객체로 변환 == 역직렬화
    ...
    public void addArticle() throws Exception{
        ...
        // when 블로그 글 추가 API에 요청을 보냄, 요청 타입은 JSON이며 given절에서 미리 만들어둔 객체를 요청 본문으로 함께 보냄
        // 설정한 내용을 바탕으로 요청 전송
